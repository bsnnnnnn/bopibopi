...
class MelSpectrograms(models.Model):
    id = models.AutoField(primary_key=True)
    call_history = models.ForeignKey(CallHistory, on_delete=models.CASCADE, related_name='mel_spectrograms_data')
...
class MFCC(models.Model):
    id = models.AutoField(primary_key=True)
    call_history = models.ForeignKey(CallHistory, on_delete=models.CASCADE, related_name='mfcc_data')
